...
navbar =
    header [ class "row center-y spacing--between app-header" ]
        ...
        , div [ class "row center-y spacing--medium" ]
            [ a [ class "link", href (Route.toHref Route.Home) ] [ text "Accueil" ]
            , a [ class "link", href (Route.toHref Route.Images_Create) ] [ text "Ajouter une image" ]
            , a [ class "link", href (Route.toHref Route.Categories_Top) ] [ text "Catégories" ]
            , a [ class "link", href (Route.toHref Route.About) ] [ text "À propos" ]
            ]
        ]
