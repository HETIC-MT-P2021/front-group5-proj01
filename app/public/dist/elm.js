...
var $author$project$Pages$Categories$Top$page = $author$project$Page$element(
	{init: $author$project$Pages$Categories$Top$init, subscriptions: $author$project$Pages$Categories$Top$subscriptions, update: $author$project$Pages$Categories$Top$update, view: $author$project$Pages$Categories$Top$view});
...
var $author$project$Pages$Images$Create$init = function (_v0) {
	return _Utils_Tuple2(
		{categories: $elm$core$Maybe$Nothing, description: '', fileName: $elm$core$Maybe$Nothing, fileUrl: '', image: $elm$core$Maybe$Nothing, imageFile: $elm$core$Maybe$Nothing, selectedCategoryId: $elm$core$Maybe$Nothing, selectedTags: ''},
...
var $author$project$Services$Images$encodePostImage = function (postImage) {
	var attributes = _List_fromArray(
		[
			_Utils_Tuple2(
			'fileName',
			$elm$json$Json$Encode$string(postImage.fileName)),
			_Utils_Tuple2(
			'description',
			$elm$json$Json$Encode$string(postImage.description)),
			_Utils_Tuple2(
			'fileUrl',
			$elm$json$Json$Encode$string(postImage.fileUrl)),
			_Utils_Tuple2(
			'categoryId',
			$elm$json$Json$Encode$int(postImage.categoryId)),
			_Utils_Tuple2(
			'tags',
			$elm$json$Json$Encode$string(postImage.tags))
		]);
	return $elm$json$Json$Encode$object(attributes);
};
var $author$project$Models$Image = F6(
	function (imageId, fileName, description, createdAt, fileUrl, categoryId) {
		return {categoryId: categoryId, createdAt: createdAt, description: description, fileName: fileName, fileUrl: fileUrl, imageId: imageId};
	});
		...
		return $elm$http$Http$post(
			{
				...
				expect: A2($elm$http$Http$expectJson, onSave, $author$project$Services$Images$imageDecoder),
		...
		switch (msg.$) {
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								categories: $elm$core$Maybe$Just(fectchedCategories)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							imageFile: $elm$core$Maybe$Just(file)
						}),
					$elm$core$Platform$Cmd$none);
			...
			case 'SetSelectedCategory':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selectedCategoryId: $elm$core$Maybe$Just(
								A2(
			...
			case 'OnUploadFile':
				...
				if (result.$ === 'Ok') {
					...
					var _v4 = model.selectedCategoryId;
					if (_v4.$ === 'Just') {
						var selectedCategoryId = _v4.a;
						var _v5 = model.fileName;
						if (_v5.$ === 'Just') {
							var fileName = _v5.a;
							return _Utils_Tuple2(
								_Utils_update(
								...
								A2(
									...
									{categoryId: selectedCategoryId, description: model.description, fileName: fileName, fileUrl: fileUrl.fileUrl, tags: model.selectedTags},
...
var $author$project$Pages$Images$Create$ImageRequested = {$: 'ImageRequested'};
...
var $author$project$Pages$Images$Create$SetSelectedCategory = function (a) {
	return {$: 'SetSelectedCategory', a: a};
};
var $author$project$Pages$Images$Create$SetSelectedTag = function (a) {
	return {$: 'SetSelectedTag', a: a};
};
var $author$project$Pages$Images$Create$SubmitForm = {$: 'SubmitForm'};
								...
								[
									...
									_List_fromArray(
										[
											...
											function () {
											var _v2 = model.selectedCategoryId;
											if (_v2.$ === 'Nothing') {
												return A2(
													$elm$html$Html$label,
													_List_Nil,
														...
														[
															...
															_List_fromArray(
																[
																	...
																	function () {
																		var _v3 = model.categories;
																		if (_v3.$ === 'Nothing') {
																			return _List_fromArray(
																				[
																					{categoryId: 0, categoryName: 'Par défaut'}
																				]);
																		} else {
												...
												[
													...
													_List_fromArray(
														[
															...
															$elm$html$Html$Attributes$value(model.selectedTags),
...
var $author$project$Generated$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'About':
			return $author$project$Generated$Pages$pages.about.init(_Utils_Tuple0);
		case 'Home':
			return $author$project$Generated$Pages$pages.home.init(_Utils_Tuple0);
		case 'NotFound':
...
var $author$project$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		...
		case 'About_Model':
			var model = bigModel.a;
			return $author$project$Generated$Pages$pages.about.bundle(model);
		case 'Home_Model':
			var model = bigModel.a;
			return $author$project$Generated$Pages$pages.home.bundle(model);
		case 'NotFound_Model':
			var model = bigModel.a;
